...
echo "Starting Realm Gateway as nest.gwa.cesproto.re2ee.org"
export LOG_LEVEL=WARNING
cd /customer_edge_switching_v2/src
./rgw.py  --name             nest.gwa.cesproto.re2ee.org                     \
          --dns-soa          nest.gwa.cesproto.re2ee.org.                    \
                             10.168.192.in-addr.arpa. 0.168.192.in-addr.arpa.\
          --dns-cname-soa    nest.gwa.cesproto.re2ee.org.                    \
          ...
          --ipt-markdnat                                                     \
          --ipt-flush                                                        \
          --repository-subscriber-folder /customer_edge_switching_v2/config.d/nest.gwa.cesproto.re2ee.org.subscriber.d/ \
          --repository-policy-folder     /customer_edge_switching_v2/config.d/nest.gwa.cesproto.re2ee.org.policy.d/     \
