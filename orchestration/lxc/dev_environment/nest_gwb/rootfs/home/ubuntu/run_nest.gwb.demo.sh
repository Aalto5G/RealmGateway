...
echo "Starting Realm Gateway as nest.gwb.demo"
export LOG_LEVEL=WARNING
cd /customer_edge_switching_v2/src
./rgw.py  --name             nest.gwb.demo                                   \
          --dns-soa          nest.gwb.demo.                                  \
                             10.168.192.in-addr.arpa. 0.168.192.in-addr.arpa.\
          --dns-cname-soa    nest.gwb.demo.                                  \
          ...
          --ipt-markdnat                                                     \
          --ipt-flush                                                        \
          --repository-subscriber-folder /customer_edge_switching_v2/config.d/nest.gwb.demo.subscriber.d/ \
          --repository-policy-folder     /customer_edge_switching_v2/config.d/nest.gwb.demo.policy.d/     \
